...
<h2>
<?php _e('Edit Field', 'ecpt'); ?> - <a href="admin.php?page=easy-content-types-metaboxes&fields-edit=<?php echo absint( $_GET['fields-edit'] ); ?>" title="Go Back"><?php _e('Go Back', 'ecpt'); ?></a>
</h2>
	...
	<table class="form-table">
		...
		<?php
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" id="field-name" name="field-name" value="<?php echo esc_attr( stripslashes( utf8_decode($field->nicename) ) ); ?>"  class="ecpt-text no-float"/>
			...
			<tr class="form-field">
				...
				<td>
					<textarea id="field-desc" name="field-desc"  class="ecpt-textarea no-float"><?php echo esc_textarea( stripslashes(utf8_decode($field->description) ) ); ?></textarea>
