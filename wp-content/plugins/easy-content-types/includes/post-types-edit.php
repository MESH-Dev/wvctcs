				...
				{			
					?>			
						...
						<tr class="form-field">
							...
							<td>
								<input type="text" name="posttype-singlular" id="posttype-singlular" value="<?php echo esc_attr( utf8_decode($posttype->singular_name) ); ?>" />
						...
						<tr class="form-field">
							...
							<td>							
								<input type="text" name="posttype-plural" id="posttype-plural" value="<?php echo esc_attr( utf8_decode($posttype->plural_name) ); ?>" />
						...
						<tr class="form-field">
							...
							<td>
								<div id="ecpt-advanced-labels" style="display:none;">
									...
									<input type="text" name="advanced-labels[add-new]" id="ecpt-advanced-labels[add-new]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['add_new']); ?>"/>
									...
									<input type="text" name="advanced-labels[all-items]" id="ecpt-advanced-labels[all-items]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['all_items']); ?>"/>
									...
									<input type="text" name="advanced-labels[add-new-item]" id="ecpt-advanced-labels[add-new-item]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['add_new_item']); ?>"/>
									...
									<input type="text" name="advanced-labels[edit-item]" id="ecpt-advanced-labels[edit-item]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['edit_item']); ?>"/>
									...
									<input type="text" name="advanced-labels[new-item]" id="ecpt-advanced-labels[new-item]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['new_item']); ?>"/>
									...
									<input type="text" name="advanced-labels[view-item]" id="ecpt-advanced-labels[view-item]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['view_item']); ?>"/>
									...
									<input type="text" name="advanced-labels[search-items]" id="ecpt-advanced-labels[search-items]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['search_items']); ?>"/>
									...
									<input type="text" name="advanced-labels[not-found]" id="ecpt-advanced-labels[not-found]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['not_found']); ?>"/>
									...
									<input type="text" name="advanced-labels[not-found-in-trash]" id="ecpt-advanced-labels[not-found-in-trash]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['not_found_in_trash']); ?>"/>
									...
									<input type="text" name="advanced-labels[parent-item-colon]" id="ecpt-advanced-labels[parent-item-colon]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['parent_item_colon']); ?>"/>
									...
									<input type="text" name="advanced-labels[menu-name]" id="ecpt-advanced-labels[menu-name]" class="ecpt-text" tabindex="2" value="<?php echo esc_attr($advanced_labels['menu_name']); ?>"/>
